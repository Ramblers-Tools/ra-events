 ...
 * @since  2.1.0
 */
class ApisiteModel extends AdminModel {
     ...
     * @since  2.1.0
     */
    public $typeAlias = 'com_ra_events.apisite';
     ...
     * @since   2.1.0
     */
    public function getTable($type = 'Apisite', $prefix = 'Administrator', $config = array()) {
    ...
    protected function loadFormData() {
        ...
        $data = Factory::getApplication()->getUserState('com_ra_events.edit.apisite.data', array());
    ...
    /**
     * Method to duplicate an Apisite
     *
    ...
    protected function prepareTable($table) {
        ...
        if (empty($table->id)) {
            ...
            if (@$table->ordering === '') {
                $db = $this->getDbo();
                $db->setQuery('SELECT MAX(ordering) FROM #__ra_api_sites');
                $max = $db->loadResult();
