...
class EventtypeModel extends AdminModel
{
	 ...
	 * @since  2.0
	 */
	public $typeAlias = 'com_ra_events.eventtype';
	 ...
	 * @since   2.0
	 */
	public function getTable($type = 'Eventtype', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ra_events.edit.eventtype.data', array());
	...
	/**
	 * Method to duplicate an Eventtype
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ra_event_types');
				$max             = $db->loadResult();
